...
def main():
    ...
    with tab2:
        ...
        with dm2:
            ...
            with st.form("entry_form", clear_on_submit=True):
                ...
                fdesc2 = st.text_area("Description", value=str(edit_row.get("Description","")), key="fd2", height=68)
                ...
                frem2 = st.text_area("Remarks", value=str(edit_row.get("Remarks","")), key="fr2", height=68)
    ...
    with tab3:
        ...
        with st.form("task_form", clear_on_submit=True):
            ...
            trem = st.text_area("Remarks", value=str(t_edit_row.get("Remarks","")), key="trm", height=68)
